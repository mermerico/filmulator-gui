...
TEST_CASE("whiteBalance identity mapping", "[golden][whiteBalance]") {
    ...
    whiteBalance(input, output, temperature, tint, p.cam2rgb, p.rCamMul, p.gCamMul, p.bCamMul,
                 p.rPreMul, p.gPreMul, p.bPreMul, expCompMult);
...
TEST_CASE("whiteBalance neutral preservation", "[golden][whiteBalance]") {
    ...
    whiteBalance(input, output, temperature, tint, p.cam2rgb, p.rCamMul, p.gCamMul, p.bCamMul,
                 p.rPreMul, p.gPreMul, p.bPreMul, 1.0f);
