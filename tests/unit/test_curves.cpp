...
TEST_CASE("shadows_highlights with identity control points", "[curves]") {
    ...
    REQUIRE(shadows_highlights(0.0f, shadowsX, shadowsY, highlightsX, highlightsY)
            == Catch::Approx(0.0f).margin(0.01f));
    REQUIRE(shadows_highlights(0.5f, shadowsX, shadowsY, highlightsX, highlightsY)
            == Catch::Approx(0.5f).margin(0.01f));
    REQUIRE(shadows_highlights(1.0f, shadowsX, shadowsY, highlightsX, highlightsY)
