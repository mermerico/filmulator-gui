...
#pragma omp parallel
    {
        ...
        for(int row = 0; row < nrows; row++) {
            for(int col = 0; col<ncols; col++) {
                ...
                const float crosstalkG = inputG + sumSurplus*highlight_crosstalk - (gSurplus*rSurplus/maxSurplus)*highlight_crosstalk;
                const float crosstalkB = inputB + sumSurplus*highlight_crosstalk - (bSurplus*rSurplus/maxSurplus)*highlight_crosstalk;
                //rolloff
