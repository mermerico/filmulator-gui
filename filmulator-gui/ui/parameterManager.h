...
class ParameterManager : public QObject {
  ...
  Q_PROPERTY(QString fullFilenameQstr READ getFullFilenameQstr NOTIFY
                 fullFilenameQstrChanged)
  Q_PROPERTY(int sensitivity READ getSensitivity NOTIFY sensitivityChanged)
  Q_PROPERTY(
      QString exposureTime READ getExposureTime NOTIFY exposureTimeChanged)
  ...
  Q_PROPERTY(
      QString exifLensName READ getExifLensName NOTIFY exifLensNameChanged)
  Q_PROPERTY(bool autoCaAvail READ getAutoCaAvail NOTIFY autoCaAvailChanged)
  Q_PROPERTY(
      bool lensfunCaAvail READ getLensfunCaAvail NOTIFY lensfunCaAvailChanged)
  Q_PROPERTY(bool lensfunVignAvail READ getLensfunVignAvail NOTIFY
                 lensfunVignAvailChanged)
  Q_PROPERTY(bool lensfunDistAvail READ getLensfunDistAvail NOTIFY
                 lensfunDistAvailChanged)
  // Read-only thing for custom wb
  Q_PROPERTY(
      bool customWbAvail READ getCustomWbAvail NOTIFY customWbAvailChanged)
  // Read-only thing for general monochromeness (monochrome raws don't need
  // this)
  Q_PROPERTY(bool colorAvail READ getColorAvail NOTIFY colorAvailChanged)
  // Read-only thing for demosaicing
  Q_PROPERTY(
      bool demosaicAvail READ getDemosaicAvail NOTIFY demosaicAvailChanged)
  ...
  // Demosaic
  Q_PROPERTY(int caEnabled MEMBER s_caEnabled WRITE setCaEnabled NOTIFY
                 caEnabledChanged)
  Q_PROPERTY(int demosaicMethod MEMBER m_demosaicMethod WRITE setDemosaicMethod
                 NOTIFY demosaicMethodChanged)

  Q_PROPERTY(int defCaEnabled READ getDefCaEnabled NOTIFY defCaEnabledChanged)
  Q_PROPERTY(int defDemosaicMethod READ getDefDemosaicMethod NOTIFY
                 defDemosaicMethodChanged)

  // Postdemosaic
  Q_PROPERTY(float temperature MEMBER m_temperature WRITE setTemperature NOTIFY
                 temperatureChanged)
  Q_PROPERTY(float tint MEMBER m_tint WRITE setTint NOTIFY tintChanged)
  Q_PROPERTY(int highlights MEMBER m_highlights WRITE setHighlights NOTIFY
                 highlightsChanged)
  Q_PROPERTY(float exposureComp MEMBER m_exposureComp WRITE setExposureComp
                 NOTIFY exposureCompChanged)

  Q_PROPERTY(
      float defTemperature READ getDefTemperature NOTIFY defTemperatureChanged)
  Q_PROPERTY(float defTint READ getDefTint NOTIFY defTintChanged)
  Q_PROPERTY(
      int defHighlights READ getDefHighlights NOTIFY defHighlightsChanged)
  Q_PROPERTY(float defExposureComp READ getDefExposureComp NOTIFY
                 defExposureCompChanged)

  // Noise reduction (split into 3 stages)
  Q_PROPERTY(bool nrEnabled MEMBER m_nrEnabled WRITE setNrEnabled NOTIFY
                 nrEnabledChanged)
  Q_PROPERTY(int nlClusters MEMBER m_nlClusters WRITE setNlClusters NOTIFY
                 nlClustersChanged)
  Q_PROPERTY(
      float nlThresh MEMBER m_nlThresh WRITE setNlThresh NOTIFY nlThreshChanged)
  Q_PROPERTY(float nlStrength MEMBER m_nlStrength WRITE setNlStrength NOTIFY
                 nlStrengthChanged)
  Q_PROPERTY(float impulseThresh MEMBER m_impulseThresh WRITE setImpulseThresh
                 NOTIFY impulseThreshChanged)
  Q_PROPERTY(float chromaStrength MEMBER m_chromaStrength WRITE
                 setChromaStrength NOTIFY chromaStrengthChanged)

  Q_PROPERTY(bool defNrEnabled READ getDefNrEnabled NOTIFY defNrEnabledChanged)
  Q_PROPERTY(
      int defNlClusters READ getDefNlClusters NOTIFY defNlClustersChanged)
  Q_PROPERTY(float defNlThresh READ getDefNlThresh NOTIFY defNlThreshChanged)
  Q_PROPERTY(
      float defNlStrength READ getDefNlStrength NOTIFY defNlStrengthChanged)
  Q_PROPERTY(float defImpulseThresh READ getDefImpulseThresh NOTIFY
                 defImpulseThreshChanged)
  Q_PROPERTY(float defChromaStrength READ getDefChromaStrength NOTIFY
                 defChromaStrengthChanged)

  // Prefilmulation
  Q_PROPERTY(QString lensfunName MEMBER s_lensfunName WRITE setLensfunName
                 NOTIFY lensfunNameChanged)
  Q_PROPERTY(int lensfunCa MEMBER s_lensfunCa WRITE setLensfunCa NOTIFY
                 lensfunCaChanged)
  Q_PROPERTY(int lensfunVign MEMBER s_lensfunVign WRITE setLensfunVign NOTIFY
                 lensfunVignChanged)
  Q_PROPERTY(int lensfunDist MEMBER s_lensfunDist WRITE setLensfunDist NOTIFY
                 lensfunDistChanged)
  Q_PROPERTY(float rotationAngle MEMBER m_rotationAngle WRITE setRotationAngle
                 NOTIFY rotationAngleChanged)
  Q_PROPERTY(float rotationPointX MEMBER m_rotationPointX WRITE
                 setRotationPointX NOTIFY rotationPointXChanged)
  Q_PROPERTY(float rotationPointY MEMBER m_rotationPointY WRITE
                 setRotationPointY NOTIFY rotationPointYChanged)

  Q_PROPERTY(QString defLensfunName READ getDefLensfunName NOTIFY
                 defLensfunNameChanged)
  Q_PROPERTY(int defLensfunCa READ getDefLensfunCa NOTIFY defLensfunCaChanged)
  Q_PROPERTY(
      int defLensfunVign READ getDefLensfunVign NOTIFY defLensfunVignChanged)
  Q_PROPERTY(
      int defLensfunDist READ getDefLensfunDist NOTIFY defLensfunDistChanged)
  Q_PROPERTY(float defRotationAngle READ getDefRotationAngle NOTIFY
                 defRotationAngleChanged)
  Q_PROPERTY(float defRotationPointX READ getDefRotationPointX NOTIFY
                 defRotationPointXChanged)
  Q_PROPERTY(float defRotationPointY READ getDefRotationPointY NOTIFY
                 defRotationPointYChanged)

  // Filmulation
  Q_PROPERTY(
      float initialDeveloperConcentration MEMBER m_initialDeveloperConcentration
          WRITE setInitialDeveloperConcentration NOTIFY
              initialDeveloperConcentrationChanged)
  Q_PROPERTY(float reservoirThickness MEMBER m_reservoirThickness WRITE
                 setReservoirThickness NOTIFY reservoirThicknessChanged)
  Q_PROPERTY(float activeLayerThickness MEMBER m_activeLayerThickness WRITE
                 setActiveLayerThickness NOTIFY activeLayerThicknessChanged)
  Q_PROPERTY(float crystalsPerPixel MEMBER m_crystalsPerPixel WRITE
                 setCrystalsPerPixel NOTIFY crystalsPerPixelChanged)
  Q_PROPERTY(float initialCrystalRadius MEMBER m_initialCrystalRadius WRITE
                 setInitialCrystalRadius NOTIFY initialCrystalRadiusChanged)
  Q_PROPERTY(
      float initialSilverSaltDensity MEMBER m_initialSilverSaltDensity WRITE
          setInitialSilverSaltDensity NOTIFY initialSilverSaltDensityChanged)
  Q_PROPERTY(
      float developerConsumptionConst MEMBER m_developerConsumptionConst WRITE
          setDeveloperConsumptionConst NOTIFY developerConsumptionConstChanged)
  Q_PROPERTY(float crystalGrowthConst MEMBER m_crystalGrowthConst WRITE
                 setCrystalGrowthConst NOTIFY crystalGrowthConstChanged)
  Q_PROPERTY(
      float silverSaltConsumptionConst MEMBER m_silverSaltConsumptionConst WRITE
          setSilverSaltConsumptionConst NOTIFY
              silverSaltConsumptionConstChanged)
  Q_PROPERTY(float totalDevelopmentTime MEMBER m_totalDevelopmentTime WRITE
                 setTotalDevelopmentTime NOTIFY totalDevelopmentTimeChanged)
  Q_PROPERTY(int agitateCount MEMBER m_agitateCount WRITE setAgitateCount NOTIFY
                 agitateCountChanged)
  Q_PROPERTY(int developmentSteps MEMBER m_developmentSteps WRITE
                 setDevelopmentSteps NOTIFY developmentStepsChanged)
  Q_PROPERTY(
      float filmArea MEMBER m_filmArea WRITE setFilmArea NOTIFY filmAreaChanged)
  Q_PROPERTY(float sigmaConst MEMBER m_sigmaConst WRITE setSigmaConst NOTIFY
                 sigmaConstChanged)
  Q_PROPERTY(float layerMixConst MEMBER m_layerMixConst WRITE setLayerMixConst
                 NOTIFY layerMixConstChanged)
  Q_PROPERTY(float layerTimeDivisor MEMBER m_layerTimeDivisor WRITE
                 setLayerTimeDivisor NOTIFY layerTimeDivisorChanged)
  Q_PROPERTY(float rolloffBoundary MEMBER m_rolloffBoundary WRITE
                 setRolloffBoundary NOTIFY rolloffBoundaryChanged)
  Q_PROPERTY(float toeBoundary MEMBER m_toeBoundary WRITE setToeBoundary NOTIFY
                 toeBoundaryChanged)

  Q_PROPERTY(float defInitialDeveloperConcentration READ
                 getDefInitialDeveloperConcentration NOTIFY
                     defInitialDeveloperConcentrationChanged)
  Q_PROPERTY(float defReservoirThickness READ getDefReservoirThickness NOTIFY
                 defReservoirThicknessChanged)
  Q_PROPERTY(float defActiveLayerThickness READ getDefActiveLayerThickness
                 NOTIFY defActiveLayerThicknessChanged)
  Q_PROPERTY(float defCrystalsPerPixel READ getDefCrystalsPerPixel NOTIFY
                 defCrystalsPerPixelChanged)
  Q_PROPERTY(float defInitialCrystalRadius READ getDefInitialCrystalRadius
                 NOTIFY defInitialCrystalRadiusChanged)
  Q_PROPERTY(
      float defInitialSilverSaltDensity READ getDefInitialSilverSaltDensity
          NOTIFY defInitialSilverSaltDensityChanged)
  Q_PROPERTY(
      float defDeveloperConsumptionConst READ getDefDeveloperConsumptionConst
          NOTIFY defDeveloperConsumptionConstChanged)
  Q_PROPERTY(float defCrystalGrowthConst READ getDefCrystalGrowthConst NOTIFY
                 defCrystalGrowthConstChanged)
  Q_PROPERTY(
      float defSilverSaltConsumptionConst READ getDefSilverSaltConsumptionConst
          NOTIFY defSilverSaltConsumptionConstChanged)
  Q_PROPERTY(float defTotalDevelopmentTime READ getDefTotalDevelopmentTime
                 NOTIFY defTotalDevelopmentTimeChanged)
  Q_PROPERTY(
      int defAgitateCount READ getDefAgitateCount NOTIFY defAgitateCountChanged)
  Q_PROPERTY(int defDevelopmentSteps READ getDefDevelopmentSteps NOTIFY
                 defDevelopmentStepsChanged)
  Q_PROPERTY(float defFilmArea READ getDefFilmArea NOTIFY defFilmAreaChanged)
  Q_PROPERTY(
      float defSigmaConst READ getDefSigmaConst NOTIFY defSigmaConstChanged)
  Q_PROPERTY(float defLayerMixConst READ getDefLayerMixConst NOTIFY
                 defLayerMixConstChanged)
  Q_PROPERTY(float defLayerTimeDivisor READ getDefLayerTimeDivisor NOTIFY
                 defLayerTimeDivisorChanged)
  Q_PROPERTY(float defRolloffBoundary READ getDefRolloffBoundary NOTIFY
                 defRolloffBoundaryChanged)
  Q_PROPERTY(
      float defToeBoundary READ getDefToeBoundary NOTIFY defToeBoundaryChanged)

  // Whitepoint & Blackpoint
  Q_PROPERTY(float blackpoint MEMBER m_blackpoint WRITE setBlackpoint NOTIFY
                 blackpointChanged)
  Q_PROPERTY(float whitepoint MEMBER m_whitepoint WRITE setWhitepoint NOTIFY
                 whitepointChanged)
  Q_PROPERTY(float cropHeight MEMBER m_cropHeight WRITE setCropHeight NOTIFY
                 cropHeightChanged)
  Q_PROPERTY(float cropAspect MEMBER m_cropAspect WRITE setCropAspect NOTIFY
                 cropAspectChanged)
  Q_PROPERTY(float cropVoffset MEMBER m_cropVoffset WRITE setCropVoffset NOTIFY
                 cropVoffsetChanged)
  Q_PROPERTY(float cropHoffset MEMBER m_cropHoffset WRITE setCropHoffset NOTIFY
                 cropHoffsetChanged)
  Q_PROPERTY(
      int rotation MEMBER m_rotation WRITE setRotation NOTIFY rotationChanged)

  Q_PROPERTY(
      float defBlackpoint READ getDefBlackpoint NOTIFY defBlackpointChanged)
  Q_PROPERTY(
      float defWhitepoint READ getDefWhitepoint NOTIFY defWhitepointChanged)
  ...
  Q_PROPERTY(
      float shadowsX MEMBER m_shadowsX WRITE setShadowsX NOTIFY shadowsXChanged)
  Q_PROPERTY(
      float shadowsY MEMBER m_shadowsY WRITE setShadowsY NOTIFY shadowsYChanged)
  Q_PROPERTY(float highlightsX MEMBER m_highlightsX WRITE setHighlightsX NOTIFY
                 highlightsXChanged)
  Q_PROPERTY(float highlightsY MEMBER m_highlightsY WRITE setHighlightsY NOTIFY
                 highlightsYChanged)
  Q_PROPERTY(
      float vibrance MEMBER m_vibrance WRITE setVibrance NOTIFY vibranceChanged)
  Q_PROPERTY(float saturation MEMBER m_saturation WRITE setSaturation NOTIFY
                 saturationChanged)
  Q_PROPERTY(bool monochrome MEMBER m_monochrome WRITE setMonochrome NOTIFY
                 monochromeChanged)
  Q_PROPERTY(
      float bwRmult MEMBER m_bwRmult WRITE setBwRmult NOTIFY bwRmultChanged)
  Q_PROPERTY(
      float bwGmult MEMBER m_bwGmult WRITE setBwGmult NOTIFY bwGmultChanged)
  Q_PROPERTY(
      float bwBmult MEMBER m_bwBmult WRITE setBwBmult NOTIFY bwBmultChanged)
  ...
  Q_PROPERTY(
      float defHighlightsX READ getDefHighlightsX NOTIFY defHighlightsXChanged)
  Q_PROPERTY(
      float defHighlightsY READ getDefHighlightsY NOTIFY defHighlightsYChanged)
  Q_PROPERTY(float defVibrance READ getDefVibrance NOTIFY defVibranceChanged)
  Q_PROPERTY(
      float defSaturation READ getDefSaturation NOTIFY defSaturationChanged)
  Q_PROPERTY(
      bool defMonochrome READ getDefMonochrome NOTIFY defMonochromeChanged)
...
public:
  ...
  // So that we write back to the database, the db gets the proper "autoselect"
  // values
  ...
  // We make them public so that we can avoid race conditions when grabbing
  // image pipeline data
  QMutex paramMutex;
  QMutex signalMutex;

  // Each stage creates its struct, checks validity, marks the validity to
  // indicate it's begun, and then returns the struct and the validity. There's
  // a second validity-check-only method for more frequent cancellation. And the
  // final marking of complete checks one more time (and doesn't mark complete
  // if invalid) Input
  ...
  // Demosaic
  std::tuple<Valid, AbortStatus, LoadParams, DemosaicParams>
  claimDemosaicParams();
  ...
  // Global, all-color curves.
  std::tuple<Valid, AbortStatus, FilmlikeCurvesParams>
  claimFilmlikeCurvesParams();
  ...
  // Filmulation
  float getDefInitialDeveloperConcentration() {
    return d_initialDeveloperConcentration;
  }
  ...
  float getDefDeveloperConsumptionConst() {
    return d_developerConsumptionConst;
  }
  float getDefCrystalGrowthConst() { return d_crystalGrowthConst; }
  float getDefSilverSaltConsumptionConst() {
    return d_silverSaltConsumptionConst;
  }
  ...
  // Filmulation
  float getInitialDeveloperConcentration() {
    return m_initialDeveloperConcentration;
  }
...
protected:
  ...
  void loadDefaults(const CopyDefaults useDefaults,
  ...
  bool autoCaAvail; // For non-Bayer sensors this is not available (also counts
                    // for demosaic)
  bool lensfunCaAvail; // These vary depending on camera and lens (and the
                       // lensfun db)
  ...
  // Prefilmulation
  QString s_lensfunName; // staging params filled at load and also when manually
                         // changed
  int s_lensfunCa; // These don't get written back
  int s_lensfunVign;
  int s_lensfunDist;
  QString m_lensfunName; // main params get loaded from db. "" or -1 indicates
                         // autoselection via exif or prefs.
  int m_lensfunCa; // When the UI sets the s_ params, these get changed so the
                   // db gets the changes too.
  ...
  QString d_lensfunName; //*not* a blank string, but actually the lens that is
                         //either exif-automatched or in prefs
  int d_lensfunCa;       //*not* -1, but actually from prefs
  int d_lensfunVign;     // They get filled a) at loading time, or b) when lens
                     // prefs are set or erased
  int d_lensfunDist;
...
signals:
  ...
  // General: if any param changes, emit this one as well after the
  // param-specific signal.
